...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="flex-align justify-content-end gap-8">
            ...
            <button type="submit" form="addGuestForm" class="btn btn-main rounded-pill py-9">Save Guest</button>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header border-bottom border-gray-100 flex-align gap-8">
            ...
            <button type="button" class="text-main-600 text-md d-flex" data-bs-toggle="tooltip" data-bs-title="Fill in guest information">
                <i class="ph-fill ph-question"></i>
            </button>
        </div>
        <div class="card-body">
            <form id="addGuestForm" action="{{ route('superadmin.guests.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-20">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="emergency_contact" class="form-control" placeholder="Emergency phone">
                    </div>
                    <div class="col-sm-6">
